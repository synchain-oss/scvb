...
//   ⚠ [SL-330b] 上面这几条**原来写着「要根治都得上 AST,对这道门禁不划算」,那个前提已经
//   不成立**:同一族(串里的 `//` 被当注释、注释冒充代码)在 `scripts/lib/strip-comments.mjs`
//   里用**词法级逐字符扫描**根治了,**没有建语法树**,而且是本文件这几支要的那种粒度
//   (哪一段是串、哪一段是注释)。本文件没跟着换是**范围**问题不是**可行性**问题 ——

        ...
        if (missed.length) {
            ...
            if (fp) {
                ...
                check(
                    threw(() =>
                        leaks(
                            fpBlock("- #SL" + fp + " - 破折号写错了"),
                            titles,
                        ),
                    ),
                    "写法不对的放行行被静默忽略了 —— 写的人只会看到「写了放行还是红」",
                );
                check(
                    threw(() =>
                        leaks(

...
//
// 判级:**不一致 = [FAIL](exit 1)**;**文档没标注 = [WARN](不影响退出码)**。
// 分级的理由:文档是冻结件,本脚本无权要求它补标注 —— 缺标注的项要走 §5 补,
// 在补上之前把 gates 卡红等于逼人改冻结文档。`--strict` 把 WARN 提成 FAIL,
// 供文档补齐标注后收紧(届时把 gates 里的调用加上 --strict 即可)。
//
// 用法:

...
private:
    ...
    bool emitClaimError(const juce::String& claim, const juce::String& prevClaim, int channelId, int groupId,
    ...
    int lastErrorOutputSr_ = -1; // error 边沿键的 outputSr 分量(Output SR 变化也重发;哨兵 -1)

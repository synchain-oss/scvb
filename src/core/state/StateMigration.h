...
// kMigrators[i] 将 abi=i+1 升到 abi=i+2。当前 abi=1,无历史格式 → 空数组。
// 未来升 abi 时在此追加 migrate_1_to_2 等,并同步 tests/golden/state/abi{N}.bin 与 StateAbiCompat 测试。
inline constexpr std::array<MigrateFn, 0> kMigrators{};

...
// bell/shelf/cut 三种形状,801 点 LUT;UI 与 DSP 共用本实现(曲线同源)。
namespace scvb
{
...
// LUT 点数:−100..+100,步长 0.25(02 §7.2)。
inline constexpr int kPanCurveLutSize = 801;
...
// 801 点 LUT:参数变化时重建(消息线程),音频线程只读;clamp + 线性插值。
class PanCurveLut
{
public:

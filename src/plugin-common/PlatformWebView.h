...
// 要找全落点就读 web-preview/tests/smoke-embedded-resources.mjs 的 **⑥ 与 ⑥c** —— 那两格
// 逐处对拍([SL-402] 起 ⑥ = 色标表 + 角度 + (e) 兜路两声明与 background 同块且
// background-attachment 排在简写之后;⑥c = 整表 + 角度),它们读哪几个路径,占位底就落
// 在哪几处([SL-377] 起 ⑥b 读的是**外圈色**那条,不是本文件这组常量的落点)。
//

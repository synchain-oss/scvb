...
// 原始布尔**,被每一帧 scvb.params 覆写 —— 一帧 false 就瞬间打掉,零缓冲;而帧本身
// **当时**是「值变了才发」([SL-251] 当时的口径;[SL-400] 起「回声位翻转」也发帧,见
// `src/output/BridgeArgs.h::planParamsFrame`),于是「宿主还在写、我们的值恰好平着」时
// 也会误熄。页面级探针实测四张卡各 1.3 次/秒翻转。J93 三裁:①灭侧加迟滞 ②图表卡摘出
// ③三张参数卡改徽标。
{

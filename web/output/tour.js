...
//     步骤机(全参数导览 39 步、步号连续)+「演示数据」badge。全部为 Output 页内的 overlay 层。
...
//     2026-08-23 指令由 7 步基线扩为全参数导览 39 步,05 §2.6 待统筹勘误,deviations 登记);
...
/**
 * tour 步骤清单(用户 2026-08-23 指令:7 步基线作废,扩为全参数导览 39 步,步号连续 1..N;

 ...
 * 瞬间打掉,零缓冲。而帧本身**当时**是「**值变了才发**」(native 当时的
 * `if (!any && !forceFull) return true;`;[SL-400] 起「回声位翻转」也发帧,见
 * `src/output/BridgeArgs.h::planParamsFrame`)—— 于是「宿主还在写、我们这一段值恰好是平的」
 * 那几百毫秒里,既没有新帧来续命、又可能来一帧带着 false 的 —— 两条路都会误熄,下一次
 * 值一变又亮回来。
 *

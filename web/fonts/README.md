...
本次生成(2026-09-02,[SL-276] 的「稍后」按钮带进一个新汉字)的规模:
拉丁 **153** 字符,CJK **769** 字符,合计 922。
...
SCVB 的 769 个 CJK 字会大面积缺字 —— 走回退期间 **gates 3h 会一直红**,这是刻意的:
...
922 个所需字符里 920 个有字形,拉丁三款按设计缺 `⇒ ① ② ④ ⓘ ⚠`(逐字回退到 Noto),

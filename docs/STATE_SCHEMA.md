...
analysis:
  ...
  segmentation: {mode: valley|vad_only, sensitivity: 0..100, min_segment_ms: 50..2000}   # [SL-411] 三项**自本版起随工程落盘**(此前只在内存里,重开回默认 valley/50/120)
